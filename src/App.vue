    ...
    <div class="container">
      <table>
          ...
          <td colspan="5">
            <div id="screen">
              ...
              <div id="screen_bottom">
                ...
                <span v-text="inputNumber" id="operand1">{{this.inputNumber}}</span>
        ...
        <tr>
          ...
          <td rowspan="2">
            <button type="button" class="btn btn-secondary long-btn" @click="Operation('+')" >+</button>
          </td>
          <td rowspan="2">
        ...
        <tr>
          <td>
            <button type="button" class="btn btn-danger" @click="showNumber('C')">C</button>
          </td>
          <td>
  ...
  methods: {
    ...
    Operation(operator){
      ...
      if(this.operator=='+'){
        ...
        this.inputNumber = this.firstNumber + this.secondNumber
      }
